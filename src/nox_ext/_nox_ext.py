...
class Session(nox.sessions.Session):
    ...
    def root_dir(self) -> Path:
        ...
        global_config_noxfile = os.path.expandvars(self._runner.global_config.noxfile)
        # Make sure we only expand the parent dir just in case the noxfile is a symlink
        return Path(os.path.realpath(os.path.dirname(global_config_noxfile)))
    ...
    def package_data(self) -> PackageData:
        return _get_package_data(self.root_dir)
